...
final class RecordDetailViewModel: ObservableObject {
    ...
    func bind(record: Record) {
        ...
        selectedParalysisDuration = record.paralysisDuration ?? ""
    ...
    func isModified(for record: Record) -> Bool {
        ...
        if visibleSections.contains(.paralysisDuration) {
            if selectedParalysisDuration != (record.paralysisDuration ?? "") {
                return true
            }
        }
        return false
    ...
    func save(record: Record, context: ModelContext) {
        ...
        record.paralysisDuration = visibleSections.contains(.paralysisDuration) ? selectedParalysisDuration : nil
